...
(function () {
  ...
  $(document).ready(function () {
    ...
    console.log();
    linkIndex = urlParams.get("cuurent")
      ? parseInt(urlParams.get("cuurent"))
      : 0;
    ...
    $("#servicesCarousel .carousel-item .minContent").append(
  ...
  function getActiveImg() {
    ...
    $("#introSliders .slider.active .imgPiece").css({
  ...
  function setPieces() {
    ...
    for (let i = 0; i < 36; i++) {
      $("#introSliders .slider .row").append(
        '<div class="col col-2"><div class="imgPiece eq0"></div></div>'
      );
    }
  }
  ...
  function changeIntroSlider(newSlider) {
    ...
    if (newSlider != lastImgIndex) {
      ...
      $("#introSliders .slider.active .caption").removeClass(
        "animate__fadeInUp"
      );
      $("#introSliders .slider.active .caption").addClass(
