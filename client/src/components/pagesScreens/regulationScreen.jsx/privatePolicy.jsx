            ...
            <ul className="list_content">
              ...
              <li>
                <p className="para">
                  ...
                  registered, and including applications and the right to apply
                  for registration of any such rights) and all inventions,
                  rights in know-how, trade secrets and confidential
                  information, customer and supplier lists and other proprietary
                  knowledge and information and all rights under licences and
                  consents in relation to any such rights and all rights and
                  forms of protection of a similar nature or having equivalent
                  or similar effect to any of these which may subsist anywhere
                  in the world for their full term, including any renewals and
                  extensions.
                </p>
              </li>
              <li>
            ...
            <ul className="list_content">
              ...
              <li>
                <p className="para">
                  ...
                  goods or services of a business, commercial or trade nature
                  must include their full names in the advert and make it clear
                  that they are selling goods or services in the course of
                  business either by the content, format, size or place of the
                  advertisement or by including words such as “trade”, “dealer”,
                  “agent”, “wholesale” or similar in the name of the advert they
              ...
              <li>
                <p className="para">
                  ...
                  number submitted to us. The call may be recorded for quality
                  assurance.
                </p>
              </li>
              <li>
              ...
              <li>
                <p className="para">
                  ...
                  matters immediately to the Company, and the Company inform the
              ...
              <li>
                <p className="para">
                  ...
                  or the Intellectual Property Rights of the owner on whose
                  behalf you are authorised to act, you may submit a
                  notification to the Company together with a request to the
                  Company to delete the relevant Material in good faith. The
                  notification and the request must contain the following
                  information:
                  <ul className="sub_list">
                    <li>
                    ...
                    <li>
                      ...
                      <ul className="inf_list">
                        ...
                        <li>
                          ...
                          being manually entered by a human that initiates the
                          flag (an “automated flagging device”), or use any such
                          flagging tool to remove posts of competitors, other
                          third parties or to remove posts without a reasonable
                          good faith belief that the post being flagged violates
                        ...
                        <li>
                          ...
                          <ul className="mino_list">
                            ...
                            <li>
                              ...
                              selling” or unsolicited advertisements of a
                              commercial nature;
                            </li>
                            <li>
                        ...
                        <li>
                          ...
                          not post any Unacceptable material and, in respect of
                          any User Material you post, you warrant that it is not
                          Unacceptable.
                        </li>
                        <li>
                          ...
                          the Service by Posting Agents; or (b) any collection,
                          aggregation, copying, duplication, display or
                          derivative use of the Service nor any use of data
                          mining, robots, spiders, or similar data gathering and
                          extraction tools for any purpose unless expressly
                          permitted by the Company or as otherwise set forth in
                          these Terms. Notwithstanding the foregoing, general
                          purpose internet search engines and non-commercial
                          public archives that gather information for the sole
                          purpose of displaying hyperlinks to the Service,
                          provided they each do so from a stable IP address or
                          range of IP addresses using an easily identifiable
                          agent and comply with our robots.txt file, may engage
                          in the activities set forth in (b). For purposes of
                          this exception, a “general purpose internet search
                          engine” does not include a website or search engine or
                          other service that specialises in classified listings
                          ...
                          reporting purposes only (e.g., for use in personal
                          ...
                          authorised access as set forth in these Terms
                          immediately terminates any permission or license
                          granted herein. In order to collect, aggregate, copy,
                          duplicate, display or make derivative use of the
                          Service or any Material made available via the Service
                          for other purposes (including commercial purposes) not
                          stated herein, you must first obtain a license from
                          the Company.
                        </li>
                        <li>
                          ...
                          purchase a Featured Ad, you may be required to
                          transmit certain information through a third party
                          service provider, Click & Buy, a third party website,
                          that may be governed by its own terms of use and other
                          policies. The Company makes no representation or
                          guarantee as to the safety or security of the
                          information transmitted to any third party website,
                          and your linking to any third party website is
                          completely at your own risk, and the Company disclaims
                        ...
                        <li>
                          ...
                          provided by users needed in order to perform their
                          functions, but may not use it for any other purpose.
                          The Company does not have access to or retain any
            ...
            <ul className="list_content">
              <li>
                <p className="para">
                  ...
                  otherwise access the Service in order to post Material on
                  behalf of others, except with express written permission or
            ...
            <ul className="list_content">
              <li>
                <p className="para">
                  ...
                  that from time to time the Company may monitor email usage
                  using human monitors or automated software to flag certain
                  words associated with spam or scams in emails that are sent
                  between one User to another in the Company’s e-mail system.
                  Any communication between yourself and any other User
                  utilising the communication features available on the Service
                  and the Website may be used only in accordance with these
                  Terms.
                </p>
              </li>
              <li>
                <p className="para">
                  ...
                  criminal penalties. Please note that the UAE Cybercrimes
                  legislation carries significant penalties including
                  imprisonment. In case you intend to solicit or contact our
                  Users by obtaining their email or phone numbers from our
                  Website, we may report this behavior to the relevant
                  authorities, who then may decide to prosecute you under the
                  relevant UAE laws.
                </p>
              </li>
            </ul>
            ...
            <ul className="list_content">
              ...
              <li>
                <p className="para">
                  ...
                  reason of any information, opinions or advice received through
                  or advertised in connection with the Website or the Service or
                  any links to the Website or Service.{" "}
                </p>
              </li>
              <li>
                <p className="para">
                  ...
                  any user or third party and that the risk of harm or damage
              ...
              <li>
                <p className="para">
                  ...
                  accessing or downloading information or any Material from the
                  Website.{" "}
                </p>
              </li>
              <li>
              ...
              <li>
                <p className="para">
                  ...
                  facilities. The Company may suspend or withdraw or restrict
                  the availability of all or any part of the Website for
                  business and operational reasons at any time and shall not be
                  liable for any interruption to the Service, whether
                  intentional or otherwise. We recommend that you back up any
                  content and data used in connection with the Website, to
                  protect yourself in case of problems with the Website or the
                  Service.{" "}
                </p>
              </li>
              <li>
                <p className="para">
                  ...
                  transaction or decision that the Website, the Service and the
                  Material are suitable for its purposes. A User in making any
                  financial or other decision based on Material or other
                  information in the Website accepts that it does so exclusively
                  at its own risk and the Company shall have no liability in
                  respect of the same.
                </p>{" "}
              </li>
              <li>
              ...
              <li>
                <p className="para">
                  ...
                  use the Website from other jurisdictions do so at their own
                  volition and risk and are responsible for compliance with
                  local law.
                </p>
              </li>
            </ul>
