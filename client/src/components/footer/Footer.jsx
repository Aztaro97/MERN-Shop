    ...
    return (
        <FooterContent>
            ...
            <Header>
                ...
                <Social>
                    <LinkM href="#" ><FaFacebook className="icon" /></LinkM>
                    <LinkM href="#"><FaTwitter className="icon" /></LinkM>
                    <LinkM href="#"><FaLinkedinIn className="icon" /></LinkM>
                    <LinkM href="#"><FaInstagram className="icon" /></LinkM>
                </Social>
            </Header>
            <hr />
            <Grid>
            ...
            <hr />
            <h4>Copyright &copy; 2021. <span>au79code.</span> All Rights Reserved </h4>
            </MainContainer>
        </FooterContent>
    )
}
